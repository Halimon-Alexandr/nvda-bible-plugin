...
Також швидко змінювати книги, розділи та переклади можна комбінаціями клавіш
...
Натиснувши **контекстне меню** (наприклад, клавішею **Applications** або **Shift+F10**) на будь-якому вірші, можна:

- Переглянути **паралельні місця**.
- **Скопіювати** поточний вірш із посиланням на нього.
- Скопіювати **діапазон віршів**, якщо виділено кілька віршів.

#### Інші комбінації клавіш

- **Ctrl+F** — відкриває вікно пошуку в Біблії, завдяки якому можна знайти потрібний вірш за словом чи фразою.
